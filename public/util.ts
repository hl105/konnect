...
const operations: Operation[] = [
  ...
  {
    name: "Post (Define) a badge (content should have name (string), logo (string), threshold (number), hashtags(string[]))",
    endpoint: "/api/badges",
    method: "POST",
    fields: {content: "json"}, 
  },
  ...
  {
    name: "Get Posts by objectID",
    endpoint: "/api/posts/objectID/:objectID",
    method: "GET",
  ...
  {
    name: "Update Post",
    endpoint: "/api/posts/:objectID",
    method: "PATCH",
    fields: { objectID: "input", content: "json" },
  },
  {
    name: "Delete Post",
  ...
  },
  {
    ...
    method: "POST",
    fields: { postId: "input", text:"input", title: "input", image: "input"},
  },
  {
    name: "Update Comment",
